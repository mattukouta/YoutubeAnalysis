...
class GetSubscriptionVideoUseCase @Inject constructor(
    ...
    fun get(
        ...
        pagingSourceFactory = {
            videoRepository.loadSubscriptionVideos(filter)
        },
...
class SubscriptionVideoMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            Timber.d("ktakamat:pagetoken(subscriptionQuery=${subscriptionQuery.pageToken}, videoQuery=${videoQuery.pageToken})")
            when {
...
//                    }
    ...
    private suspend fun requestVideos(loadType: LoadType): MediatorResult {
        ...
        return when {
            ...
            error.isEmpty() -> MediatorResult.Success(subscriptionQuery.pageToken == null)
